package com.example.lasse.doodlz;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.fill_color:
                FillColorDialogFragment fillColorDialogFragment = new FillColorDialogFragment();
                fillColorDialogFragment.show(getFragmentManager(), "fill color dialog");
